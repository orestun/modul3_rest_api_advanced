...
public class GiftCertificateRepositoryTest {
    ...
    @Test
    public void updateGiftCertificatesById(){
        this.setup();
        giftCertificateRepository.updateGiftCertificateById(5L,
                        "books-store",
                        "gc for books",
                        90,
                        new BigDecimal(100),
        ...
        GiftCertificate actualGiftCertificate = giftCertificateRepository.findById(5L).get();
        actualGiftCertificate.setTags(null);
        actualGiftCertificate.setUpdateDate(null);
        actualGiftCertificate.setCreateDate(null);
        GiftCertificate expectedGiftCertificate =
                        new GiftCertificate(5,"books-store", "gc for books", 90, new BigDecimal("100.00"));
